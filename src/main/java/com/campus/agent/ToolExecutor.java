...
import com.campus.entity.ShopType;
import com.campus.entity.Voucher;
import com.campus.service.IBlogService;
import com.campus.service.IShopService;
import com.campus.service.IShopTypeService;
import com.campus.service.IVoucherService;
...
public class ToolExecutor {
    ...
    private String executeQueryVoucherOfShop(JsonNode args) throws Exception {
        ...
        List<Map<String, Object>> result = shops.stream().map(shop -> {
            ...
            // 查询该店铺的优惠券
            com.campus.dto.Result voucherResult = voucherService.queryVoucherOfShop(shop.getId());
